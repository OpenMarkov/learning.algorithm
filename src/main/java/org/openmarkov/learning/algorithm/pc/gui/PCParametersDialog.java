...
@SuppressWarnings("serial") @AlgorithmConfiguration(algorithm = PCAlgorithm.class) public class PCParametersDialog
    ...
    private void initComponents() {
        ...
        AceptButton.addActionListener(evt -> {
            try {
    ...
    private void AceptButtonActionPerformed(
            java.awt.event.ActionEvent evt) throws InvalidArgumentException {// GEN-FIRST:event_AceptButtonActionPerformed
