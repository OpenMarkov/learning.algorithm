 ...
 * @author joliva
 */
@SuppressWarnings("serial") @AlgorithmConfiguration(algorithm = PCAlgorithm.class) public class PCParametersDialog
		extends AlgorithmParametersDialog {
	/**
	 * Implemented independence tester.
	 */
	public static final String[] independenceTesters = { "Cross entropy" };
	...
	private void initComponents() {
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addGroup(
						jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
								jPanel1Layout.createSequentialGroup().addContainerGap().addComponent(testerLabel)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(independenceTesterComboBox,
												javax.swing.GroupLayout.PREFERRED_SIZE, 118,
												javax.swing.GroupLayout.PREFERRED_SIZE)).addGroup(
								jPanel1Layout.createSequentialGroup().addGap(92, 92, 92).addComponent(AceptButton))
		...
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addGap(18, 18, 18).addGroup(
	...
	private void AceptButtonActionPerformed(
		...
		try {
			...
			if ((alpha < 0) || (alpha > 1) || (degreeAcc < 0) || (degreeAcc > 1)) {
				JOptionPane.showMessageDialog(null, stringDatabase.getString("Learning.PC.IncorrectParameter"),
	...
	@Override public LearningAlgorithm getInstance(ProbNet probNet, CaseDatabase database) {
		return new PCAlgorithm(probNet, database, Double.parseDouble(alphaParameter),
				new CrossEntropyIndependenceTester(), Double.parseDouble(significanceLevel));
	}
