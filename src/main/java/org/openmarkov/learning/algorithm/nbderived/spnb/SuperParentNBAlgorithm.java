...
import org.openmarkov.learning.algorithm.nbderived.spnb.util.SuperParentNaiveBayesEditProposal;
...
@LearningAlgorithmType(name = "Superparent naive bayes", discriminative = true)
